...
public final class Beans {
    ...
    public static <T> Ordering<T> orderByProps(String... props) {
        return new Orders.BeanOrder<T>(props);
    }
    ...
    public static <T> Ordering<T> orderByProps(Class<T> type, String... props) {
        return new Orders.BeanOrder<T>(type, props);
    }
     ...
     * @return
     */
    public static Orders.OrderBuilder<Map> orderMap() {
        return Orders.OrderBuilder.build(false);
    }
     ...
     * @return
     */
    public static <B> Orders.OrderBuilder<B> order() {
        return Orders.OrderBuilder.build(false);
    }
     ...
     * @return
     */
    public static <B> Orders.OrderBuilder<B> order(Class<B> type) {
        return Orders.OrderBuilder.build(type);
    }
