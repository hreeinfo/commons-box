 ...
 *            <p>版权所属：xingxiuyi </p>
 */
public class SafeLinkedMap<K, V> extends AbstractMap<K, V> {
    ...
    final SafeLinkedDeque<Node> evictionDeque;
    ...
    private SafeLinkedMap(Builder<K, V> builder) {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        final SafeLinkedMap<K, V> map = SafeLinkedMap.this;
    ...
    static final class CatchUpTask implements Runnable {
        ...
        final WeakReference<SafeLinkedMap<?, ?>> mapRef;

        CatchUpTask(SafeLinkedMap<?, ?> map) {
            this.mapRef = new WeakReference<SafeLinkedMap<?, ?>>(map);
        }
    ...
    static final class SerializationProxy<K, V> implements Serializable {
        ...
        SerializationProxy(SafeLinkedMap<K, V> map) {
        ...
        Object readResolve() {
            SafeLinkedMap<K, V> map = new Builder<K, V>()
    ...
    public static final class Builder<K, V> {
        ...
        /**
         * Creates a new {@link SafeLinkedMap} instance.
         *
         ...
         */
        public SafeLinkedMap<K, V> build() {
            if (capacity < 0) {
                throw new IllegalStateException();
            }
            SafeLinkedMap<K, V> map = new SafeLinkedMap<>(this);
     ...
     * <p>
     * The listener is invoked by {@link SafeLinkedMap} on a caller's thread and
    ...
    static final class Weighers {
        ...
        public static <V> Weigher<V> singleton() {
            return (Weigher<V>) Weighers.SingletonWeigher.INSTANCE;
        }
        ...
        public static <E> Weigher<? super Iterable<E>> iterable() {
            return (Weigher<Iterable<E>>) (Weigher<?>) Weighers.IterableWeigher.INSTANCE;
        }
        ...
        public static <E> Weigher<? super Collection<E>> collection() {
            return (Weigher<Collection<E>>) (Weigher<?>) Weighers.CollectionWeigher.INSTANCE;
        }
        ...
        public static <E> Weigher<? super List<E>> list() {
            return (Weigher<List<E>>) (Weigher<?>) Weighers.ListWeigher.INSTANCE;
        }
        ...
        public static <E> Weigher<? super Set<E>> set() {
            return (Weigher<Set<E>>) (Weigher<?>) Weighers.SetWeigher.INSTANCE;
        }
        ...
        public static <A, B> Weigher<? super Map<A, B>> map() {
            return (Weigher<Map<A, B>>) (Weigher<?>) Weighers.MapWeigher.INSTANCE;
        }
