 ...
 * <p>版权所属：xingxiuyi </p>
 */
public class InternalSpringAppResourceImpl implements InternalSpringResource {
    private static final AppLog LOG = Logs.get(InternalSpringResource.class);
    private final Resource resource;
    private final String url;

    public InternalSpringAppResourceImpl(Resource resource) {
        this.resource = resource;
        this.url = InternalSpringAppResourceLoader.toURLString(resource);
    }
    ...
    public boolean equals(Object o) {
        ...
        InternalSpringAppResourceImpl that = (InternalSpringAppResourceImpl) o;
