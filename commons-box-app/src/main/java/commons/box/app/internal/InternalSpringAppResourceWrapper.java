 ...
 * <p>版权所属：xingxiuyi </p>
 */
public final class InternalSpringAppResourceWrapper implements InternalSpringResource {
    private static final AppLog LOG = Logs.get(InternalSpringAppResourceWrapper.class);

    private final AppResource appResource;
    private final Resource resource;
    private final String url;

    public InternalSpringAppResourceWrapper(AppResource appResource) {
    ...
    private String tryGenURL() {
        ...
        String url = null;
        if (this.resource != null) url = InternalSpringAppResourceLoader.toURLString(this.resource);
    ...
    public boolean equals(Object o) {
        ...
        InternalSpringAppResourceWrapper that = (InternalSpringAppResourceWrapper) o;
