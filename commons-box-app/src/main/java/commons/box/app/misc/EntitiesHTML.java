 ...
 * <p>版权所属：xingxiuyi </p>
 */
public class EntitiesHTML {
    private EntitiesHTML() {
    }

    public static final Map<String, String> decodedEntities = Collections.unmodifiableMap(new HashMap<String, String>() {
        {
            put("&AElig", "\u00C6");
            put("&AElig;", "\u00C6");
            put("&AMP", "\u0026");
    ...
    public static final Map<String, String> encodedEntities = Collections.unmodifiableMap(new HashMap<String, String>() {{
        put("\\u00C6", "&AElig;");
        put("\\u0026", "&AMP;");
        put("\\u00C1", "&Aacute;");
        put("\\u0102", "&Abreve;");
